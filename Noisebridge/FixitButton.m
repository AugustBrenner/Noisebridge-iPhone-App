...
#import "FixitButton.h"

@implementation FixitButton
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Image Declarations
    UIImage* ticketingIcon = [UIImage imageNamed: @"Ticketing-Icon"];
    UIColor* ticketingIconPattern = [UIColor colorWithPatternImage: ticketingIcon];
    
    //// Frames
    CGRect frame = CGRectMake(0, 0, 134, 134);
    ...
    //// MainButton
    {
        ...
        CGRect roundedRectangleRect = CGRectMake(CGRectGetMinX(frame) + 2, CGRectGetMinY(frame) + 2, 130, 130);
        ...
        //// Ticketing-Image Drawing
        CGRect ticketingImageRect = CGRectMake(CGRectGetMinX(frame) + 17, CGRectGetMinY(frame) + 17, 100, 99);
        UIBezierPath* ticketingImagePath = [UIBezierPath bezierPathWithRect: ticketingImageRect];
        CGContextSaveGState(context);
        CGContextSetShadowWithColor(context, outerButtonShadowOffset, outerButtonShadowBlurRadius, outerButtonShadow.CGColor);
        CGContextSaveGState(context);
        CGContextSetPatternPhase(context, CGSizeMake(CGRectGetMinX(ticketingImageRect), CGRectGetMinY(ticketingImageRect)));
        [ticketingIconPattern setFill];
        [ticketingImagePath fill];
        CGContextRestoreGState(context);
        CGContextRestoreGState(context);
